...
export default function VectorRoutingTest() {
    ...
    const loggerRef = useRef(createLogger('VectorRoutingTest'));

    const runTest = async () => {
        setTesting(true);
        const logger = loggerRef.current;
        logger.system('🚀 NEW TEST RUN: Vector Routing');
        ...
        try {
            ...
            await saveToUnifiedLog(logger, {
                ...
                execution_context: 'VectorRoutingTest',
                ...
                result_summary: `Vector Routing: ${data.test_results?.passed || 0}/${data.test_results?.total || 0} passed`,
    ...
    const clearLogs = () => { loggerRef.current = createLogger('VectorRoutingTest'); };
