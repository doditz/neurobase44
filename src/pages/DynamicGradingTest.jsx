                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    ...
                    {result && (
                        <TabsContent value="results" className="space-y-6">
                            ...
                            {result.mode_b_debate_rounds_data && result.mode_b_debate_rounds_data.length > 0 && (
                                <Card className="bg-slate-800 border-purple-600">
                                    <CardHeader>
                                        <CardTitle className="text-purple-400 flex items-center gap-2">
                                            <Brain className="w-5 h-5" />
                                            SMAS Debate Rounds ({result.mode_b_debate_rounds_data.length} rounds)
                                        </CardTitle>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        {result.mode_b_debate_rounds_data.map((round, idx) => (
                            ...
                            {/* Responses Comparison - FULL HEIGHT, NO TRUNCATION */}
                                ...
                                <Card className="bg-slate-800 border-orange-600">
                                    <CardHeader>
                                        <CardTitle className="text-orange-400 text-sm flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <div className="w-3 h-3 bg-orange-500 rounded-full" />
                                                Mode A Response (Baseline)
                                            </div>
                                            <span className="text-xs text-slate-500 font-normal">
                                                {result.mode_a_response?.length || 0} chars
                                            </span>
                                        </CardTitle>
                                    </CardHeader>
                                    <CardContent>
                                ...
                                <Card className="bg-slate-800 border-green-600">
                                    <CardHeader>
                                        <CardTitle className="text-green-400 text-sm flex items-center justify-between">
                                            ...
                                            <span className="text-xs text-slate-500 font-normal">
                                                {result.mode_b_response?.length || 0} chars
                                            </span>
                                        </CardTitle>
                                    </CardHeader>
                                    <CardContent>
